...
(async () => {
  ...
  await page.goto("https://www.coolmate.me/84rising?itm_source=navbar", {
...
const scrape = async (page) => {
  ...
  if (itemList.length > 15) itemList = itemList.slice(11, -4);

  const file_name = "./streetwear/streetwear_data";
